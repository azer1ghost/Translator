                                 ...
                                 <div class="content">
                                   <div class="col-md-12">
                                       <div class="card card-plain">
                                           <div class="header">
                                               <h4 class="title">Sifariş qəbul edin</h4>
                                           </div>
                                           <div class="content table-responsive table-full-width">
                                               <table class="table table-hover">
                                                   ...
                                                   <tbody>
                                                     ...
                                                     <?php $storesor=$db->prepare("SELECT * from store where order_gave=0 order by  order_id ASC");
                                                     	     $storesor->execute();
                                                     while($storecek=$storesor->fetch(PDO::FETCH_ASSOC)){  ?>
                                                       <tr>
                                                         ...
                                                         <td>
                                                            <a href="takeorder.php?order_id=<?php echo $storecek['order_id']; ?>">
                                                                <button class="btn btn" name="button">Qəbul et »</button>
                                                            </a>
                                                         </td>
                                                       </tr>
                                                      <?php } ?>
