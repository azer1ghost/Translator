                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="content">
                                        ...
                                        <form class="" action="setting/engine.php" method="post">
                                          <input type="hidden" name="order_gave" value="<?php echo $usercek['user_id']?>">
                                          <input type="hidden" name="order_id" value="<?php echo $print['order_id'] ?>">
                                            <button style="float: right" class="btn btn-success" type="submit" name="takeorder">Sifarişi qəbul et</button>
                                        </form>
