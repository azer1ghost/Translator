                                 ...
                                 <div class="content">
                                   <div class="col-md-12">
                                       <div class="card card-plain">
                                           <div class="header">
                                               <h4 class="title">Qəbul etdiyim sifarişlər</h4>
                                           </div>
                                           ...
                                           <div class="content table-responsive table-full-width">
                                               <table class="table table-hover">
                                                   ...
                                                   <tbody>
                                                     ...
                                                     <?php $user_id=$usercek['user_id'];
                                                           $storesor=$db->prepare("SELECT * from store where order_gave=$user_id order by  order_id ASC");
                                                     	     $storesor->execute();
                                                     while($storecek=$storesor->fetch(PDO::FETCH_ASSOC)){  ?>
                                                       <tr>
                                                         ...
                                                         <td>
                                                           <a href="ordersingleclient.php?order_id=<?php echo $storecek['order_id']; ?>">
